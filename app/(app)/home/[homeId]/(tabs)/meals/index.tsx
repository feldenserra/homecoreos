...
/**
 * Recipe book — default Meals view. Nutrition is computed client-side from
 * ingredients × quantity; the grey + opens grocery / meal-plan actions.
 */
        ...
        options={{
          ...
          headerRight: () => (
            <Pressable
              ...
              onPress={() =>
                router.push(`/home/${home.id}/meals/create-recipe`)
              }
...
function RecipeCard({
  ...
  return (
    <Card style={styles.card}>
      ...
      <Text style={styles.hint}>Long-press name to delete</Text>
    </Card>
  );
}
