...
/**
 * Per-user AI provider credentials. Used by the Chat settings route.
 *
 * The list/form mode switch is kept — one provider per source, add or edit one
 * at a time. The stored API key is never returned by the Edge Function, only
 * `hasApiKey`. Editing a Cloudflare entry starts with a blank key field, and
