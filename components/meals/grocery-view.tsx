...
import { ErrorText, LoadingScreen, Muted } from "../ui";
...
/**
 * Weekly grocery list. Week state is owned by the meals shell so it survives
 * tab switches.
 */
export function GroceryView({ weekStart, onWeekChange }: Props) {
  const home = useHome();
